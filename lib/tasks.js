...
var TASKS = {
	...
	'tsk0023': {
		interface: 'itf0008',
		instruction: 'Toggle module 122122112221 to 1.',
		validate: function(option){
			var res = false;
			if(option.name === '1'){
				res = true;
	...
	'tsk0024': {
		interface: 'itf0008',
		instruction: 'Toggle module 122122112221 to 2.',
		validate: function(option){
			var res = false;
			if(option.name === '2'){
				res = true;
	...
	'tsk0025': {
		interface: 'itf0009',
		instruction: 'Toggle module 1221221212211 to 1.',
		validate: function(option){
			var res = false;
			if(option.name === '1'){
				res = true;
	...
	'tsk0026': {
		interface: 'itf0009',
		instruction: 'Toggle module 1221221212211 to 2.',
		validate: function(option){
			var res = false;
			if(option.name === '2'){
				res = true;
	...
	'tsk0027': {
		interface: 'itf0010',
		instruction: 'Toggle module 1221221122 to 1.',
		validate: function(option){
			var res = false;
			if(option.name === '1'){
				res = true;
	...
	'tsk0028': {
		interface: 'itf0010',
		instruction: 'Toggle module 1221221122 to 2.',
		validate: function(option){
			var res = false;
			if(option.name === '2'){
				res = true;
	...
	'tsk0029': {
		interface: 'itf0011',
		instruction: 'Toggle module 12212212121 to 1.',
		validate: function(option){
			var res = false;
			if(option.name === '1'){
				res = true;
	...
	'tsk0030': {
		interface: 'itf0011',
		instruction: 'Toggle module 12212212121 to 2.',
		validate: function(option){
			var res = false;
			if(option.name === '2'){
				res = true;
