var TASKS = {
	...
	'tsk0066': {
		interface: 'itf0020',
		instruction: 'Orient Arc Gauge to 312 degrees.',
		validate: function(angle){
			var res = false;
			if(angle === 312){
				res = true;
	...
	'tsk0068': {
		interface: 'itf0021' ,
		instruction: 'Cast a 1/4-wide Sonar Range in any direction.',
		validate: function(range){
			var res = false;
			var size = Math.abs(range[0] - range[1]);
			if(size === (1/4)){
	...
	'tsk0069': {
		interface: 'itf0021' ,
		instruction: 'Cast a 3/8-wide Sonar Range in any direction.',
		validate: function(range){
			var res = false;
			var size = Math.abs(range[0] - range[1]);
			if(size === (3/8)){
	...
	'tsk0070': {
		interface: 'itf0021' ,
		instruction: 'Cast a 9/12-wide Sonar Range in any direction.',
		validate: function(range){
			var res = false;
			var size = Math.abs(range[0] - range[1]);
			if(size === (9/12)){
	...
	'nmt0001': {
		interface: 'nmi0000',
		instruction: 'Set Compression Matrix to 9.',
		validate: function(sum){
			return sum === 9;
		}
	},
	'nmt0002': {
		interface: 'nmi0000',
		instruction: 'Set Compression Matrix to 8.',
		validate: function(sum){
			return sum === 8;
		}
	},
	'nmt0003': {
		interface: 'nmi0000',
		instruction: 'Set Compression Matrix to 6.',
		validate: function(sum){
			return sum === 12;
		}
	},
	'nmt0004': {
		interface: 'nmi0001',
		instruction: 'Raise turbo thrusters to 18.',
		validate: function(sum){
			return sum === 18;
		}
	},
	'nmt0005': {
		interface: 'nmi0001',
		instruction: 'Raise turbo thrusters to 43.',
		validate: function(sum){
			return sum === 43;
		}
	},
	'nmt0006': {
		interface: 'nmi0001',
		instruction: 'Raise turbo thrusters to 251.',
		validate: function(sum){
			return sum === 251;
		}
	},
	'nmt0007': {
		interface: 'nmi0001',
		instruction: 'Raise turbo thrusters to 100.',
		validate: function(sum){
			return sum === 100;
		}
	},
	'nmt0008': {
		interface: 'nmi0002',
		instruction: 'Set the redox configurant to 18.',
		validate: function(sum){
			return sum === 18;
		}
	},
	'nmt0009': {
		interface: 'nmi0002',
		instruction: 'Set the redox configurant to 10.',
		validate: function(sum){
			return sum === 10;
		}
	}, 
	'nmt0010': {
		interface: 'nmi0002',
		instruction: 'Set the redox configurant to 21.',
		validate: function(sum){
			return sum === 21;
		}
	},
	'nmt0011': {
		interface: 'nmi0002',
		instruction: 'Set the redox configurant to 30.',
		validate: function(sum){
			return sum === 30;
		}
	},
	'nmt0012': {
		interface: 'nmi0003',
		instruction: 'Tune the optic sensor to 5.',
		validate: function(sum){
			return sum === 5;
		}
	},
	'nmt0013': {
		interface: 'nmi0003',
		instruction: 'Tune the optic sensor to 9.',
		validate: function(sum){
			return sum === 9;
		}
	},
	'nmt0014': {
		interface: 'nmi0003',
		instruction: 'Tune the optic sensor to 8.',
		validate: function(sum){
			return sum === 8;
		}
	},
	'nmt0015': {
		interface: 'nmi0003',
		instruction: 'Tune the optic sensor to 6.',
		validate: function(sum){
			return sum === 12;
		}
	},
