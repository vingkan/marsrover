var TASKS = {
	...
	'tsk0055': {
		interface: 'itf0018',
		instruction: 'Broadcast a red parabolic Radiation Signal.',
		validate: function(fn){
			var res = false;
	...
	'tsk0056': {
		interface: 'itf0018',
		instruction: 'Broadcast a green scatter Radiation Signal.',
		validate: function(fn){
			var res = false;
	...
	'tsk0057': {
		interface: 'itf0018',
		instruction: 'Broadcast a blue parabolic linear Signal.',
		validate: function(fn){
			var res = false;
	...
	'tsk0058': {
		interface: 'itf0018',
		instruction: 'Broadcast a yellow parabolic sinusoidal Signal.',
		validate: function(fn){
			var res = false;
	...
	'tsk0059': {
		interface: 'itf0019',
		instruction: 'Adjust the Hot/Crazy scale to green and linear.',
		validate: function(fn){
			var res = false;
	...
	'tsk0060': {
		interface: 'itf0019',
		instruction: 'Adjust the Hot/Crazy scale to red and parabolic.',
		validate: function(fn){
			var res = false;
			if(fn.color === 'red' && fn.type === 'parabolic'){
				res = true;
	...
	'tsk0061': {
		interface: 'itf0019',
		instruction: 'Adjust the Hot/Crazy scale to blue and scatter.',
		validate: function(fn){
			var res = false;
	...
	'tsk0062': {
		interface: 'itf0019',
		instruction: 'Adjust the Hot/Crazy scale to yellow and sinusoidal.',
		validate: function(fn){
			var res = false;
			if(fn.color === 'yellow' && fn.type === 'sinusoidal'){
				res = true;
