var RENDERERS = {
	...
	start_mission: (state, data) => {
		...
		console.log('me: ', PLAYER_ID, getPlayerIndex(PLAYER_ID))
		console.log('partner: ', state.players[adjacentPidx], adjacentPidx)
		console.log(state.players[adjacentPidx], state.panels[adjacentPidx], possibleItfs);
		dispatch({
			action: 'start_task',
